...
#include "../Source/GUI/ImageViewer.h"
...
QT_MOC_LITERAL(3, 26, 8)
    ...
    "ImageViewer\0ZoomBoxDrawn\0\0zoom_box\0"
};
...
void ImageViewer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->ZoomBoxDrawn((*reinterpret_cast< const QRectF(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (ImageViewer::*_t)(const QRectF & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ImageViewer::ZoomBoxDrawn)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void ImageViewer::ZoomBoxDrawn(const QRectF & _t1)
{
